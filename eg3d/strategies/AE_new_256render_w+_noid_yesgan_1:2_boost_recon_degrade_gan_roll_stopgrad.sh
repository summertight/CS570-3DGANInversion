...
python train.py --outdir=./ae_new_128_w+_Platon_boost_recon_degrage_gan_roll_stopgrad \
--gpus=3 --batch 12 --gamma 1 \
--loss_selection l1 100 --loss_selection vgg 100 --loss_selection gan .1 --loss_selection id 1 --loss_selection tv 1 \
--workers 4 \
