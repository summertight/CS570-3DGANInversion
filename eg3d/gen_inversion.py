...
@click.option('--outdir', help='Where to save the output images', type=str, required=True, metavar='DIR', default = './out_from_retrain_ret')
...
#XXX python gen_inversion.py --outdir=out_inversion_wmap_fixed_triplane_ret --trunc=0.7 --seeds=0-3 --network=/home/nas4_user/jaeseonglee/ICCV2023/eg3d_ckpts/eg3d-fixed-triplanes-ffhq.pkl --data_path /home/nas1_userB/dataset/ffhq-dataset/images1024x1024/images1024x1024_refined
def generate_images(
    network_pkl: str,
    seeds: List[int],
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        img_path  = os.path.join(data_path, pivot_key)
        ...
        #sche = torch.optim.lr_scheduler.LambdaLR(optimizer=optm,
        #                        lr_lambda=lambda step: 0.999 ** step,
        #                        last_epoch=-1,
        #                        verbose=False)
        ...
        #import pdb;pdb.set_trace()
        #maps = [torch.nn.Parameter(torch.randn_like(map,device=device)) for map in maps_]
        ...
        for step in range(steps):
            ...
            if step%100==0:
                ...
                #import pdb;pdb.set_trace()
                PIL.Image.fromarray(imgs_save_file[0].cpu().numpy(), 'RGB').save(f'{outdir}/seed{seed:04d}_{step}.png')
            ...
            if step == steps-1:
                ...
                with open(f'{outdir}_pickles/{pivot_key}.pickle', 'wb') as f:
